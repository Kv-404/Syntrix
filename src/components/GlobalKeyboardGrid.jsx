...
export const GlobalKeyboardGrid = () => {
  const [activeNotes, setActiveNotes] = useState(new Set());
  // forceRender is removed as state updates will trigger re-renders
