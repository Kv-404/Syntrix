...
export const ModularEurorackChassis = ({
  module,
  zoom,
  onPortDragStart,
  onPortDrop,
}) => {
  const { updateModulePosition, updateModuleParameter, removeModule } =
    useSynthStore();
  ...
  const handlePointerDown = (e) => {
    ...
    if (e.target.tagName.match(/INPUT|BUTTON|SELECT|TEXTAREA/)) return;
    if (e.target.closest(".port-jack")) return;
  ...
  const handlePointerMove = (e) => {
    ...
    updateModulePosition(
      module.id,
      Math.round(newX / snap) * snap,
      Math.round(newY / snap) * snap,
    );
  };
          ...
          <>
            ...
            <div className="chassis-control-group center">
              ...
              <input
                ...
                onChange={(e) =>
                  handleParamChange("detune", parseInt(e.target.value))
                }
                className="chassis-range"
              />

              <span className="chassis-param-value">
                {module.parameters.detune} cents
              </span>
            </div>
          ...
          <>
            <div className="chassis-control-group">
              ...
              <select
                ...
                onChange={(e) =>
                  handleParamChange("filterType", e.target.value)
                }
              >
            ...
            <div className="chassis-control-group center">
              ...
              <input
                ...
                onChange={(e) =>
                  handleParamChange("cutoff", parseInt(e.target.value))
                }
                className="chassis-range"
              />
            </div>
            <div className="chassis-control-group center">
              ...
              <input
                ...
                onChange={(e) =>
                  handleParamChange("resonance", parseFloat(e.target.value))
                }
                className="chassis-range"
              />
            </div>
          ...
          <>
            ...
            <div className="chassis-control-group center">
              ...
              <input
                ...
                onChange={(e) =>
                  handleParamChange("rate", parseFloat(e.target.value))
                }
                className="chassis-range"
              />
            </div>
            ...
            {["attack", "decay", "sustain", "release"].map((param) => (
              <div key={param} className="chassis-control-group center">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleParamChange(param, parseFloat(e.target.value))
                  }
                  className="chassis-range"
                />
              </div>
          ...
          <>
            <div className="chassis-control-group center">
              ...
              <input
                ...
                onChange={(e) =>
                  handleParamChange("masterGain", parseFloat(e.target.value))
                }
                className="chassis-range"
              />
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="rack-body">{renderControls()}</div>
